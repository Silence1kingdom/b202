      ...
      <section className="border-t border-white/[0.06] pb-12 pt-16 md:pt-20">
        <div className="container-x">
          ...
          <p className="mt-4 max-w-xl text-white/55">
            مشاريع حقيقية بنيناها لعملاء حقيقيين. اضغط أي مشروع عشان تشوف تفاصيله.
          </p>
          <Link href="/about" className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-accent transition-opacity hover:opacity-80">
            تعرف علينا
