...
const FALLBACK_TEAM = [
  { name: "أحمد حمدي", role: "مؤسس وشريك تقني", avatar: "ح", bio: "أسس B_20 وبيقود الرؤية التقنية. خبرة في بناء منتجات ويب سريعة وموثوقة من الفكرة للإطلاق.", skills: ["Next.js", "Architecture", "DevOps"], tone: "from-accent/40 to-accent/10" },
  { name: "أحمد الجندي", role: "مصمم UI/UX", avatar: "ج", bio: "مصمم UI/UX بيحوّل الأفكار لتجارب بصرية نظيفة ومريحة، مهتم بالتفاصيل والحركة السلسة.", skills: ["Figma", "Design Systems", "Motion"], tone: "from-electric/40 to-electric/10" },
  { name: "الشعراوي", role: "مطور واجهات", avatar: "ش", bio: "مطور واجهات بيبني الواجهات بأحدث التقنيات مع تركيز على الأداء وتجربة المستخدم.", skills: ["React", "Tailwind", "Performance"], tone: "from-success/40 to-success/10" },
];
        ...
        <div className="container-x">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {members.map((m, i) => (
              <article
                key={m.name}
                className="group relative flex flex-col overflow-hidden rounded-3xl border border-white/[0.06] bg-white/[0.02] transition-all duration-500 hover:-translate-y-1.5 hover:border-accent/30 hover:shadow-2xl hover:shadow-accent/5"
